...
public class AchievementAward {
    ...
    private String finishedWorkunit;

    private String workunitNumber;

    private String workunitRank;

    private String awardGrantNo;
    ...
    public String getAutherNumber() {
        return autherNumber;
    }

    public void setAutherNumber(String autherNumber) {
        this.autherNumber = autherNumber == null ? null : autherNumber.trim();
    }
    ...
    public String getLicenseIssuingAgencies() {
        return licenseIssuingAgencies;
    }

    public void setLicenseIssuingAgencies(String licenseIssuingAgencies) {
        this.licenseIssuingAgencies = licenseIssuingAgencies == null ? null : licenseIssuingAgencies.trim();
    }
    ...
    public void setAwardRange(String awardRange) {
        this.awardRange = awardRange == null ? null : awardRange.trim();
    }
    ...
    public String getFinishedWorkunit() {
        return finishedWorkunit;
    }

    public void setFinishedWorkunit(String finishedWorkunit) {
        this.finishedWorkunit = finishedWorkunit == null ? null : finishedWorkunit.trim();
    }
    ...
    public void setWorkunitNumber(String workunitNumber) {
        this.workunitNumber = workunitNumber == null ? null : workunitNumber.trim();
    }

    public String getWorkunitRank() {
        return workunitRank;
    }

    public void setWorkunitRank(String workunitRank) {
        this.workunitRank = workunitRank == null ? null : workunitRank.trim();
    }

    public String getAwardGrantNo() {
        return awardGrantNo;
    }

    public void setAwardGrantNo(String awardGrantNo) {
        this.awardGrantNo = awardGrantNo == null ? null : awardGrantNo.trim();
    }
    ...
    public String getAwardForm() {
        return awardForm;
    }

    public void setAwardForm(String awardForm) {
        this.awardForm = awardForm == null ? null : awardForm.trim();
    }
